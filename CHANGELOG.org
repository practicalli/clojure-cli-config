...
* 2021-07-17
  Updated version of GitHub actions lint-with-clj-kondo.  Checks deps.edn to ensure its a valid structure.

  Changes seancorfield/clj-new to new com.github.seancorfield/clj-new

  Update hotload of library documentation - links to Practicalli Clojure page on hotloading and example project.
